            ...
            return SingleChildScrollView(
              child: Column(children: [
                  Stack(children: [
                    ...
                    Padding(padding: EdgeInsets.only(top: MediaQuery.of(context).size.height * .055),
                      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                        CircleAvatar(
                          ...
                          child: CircleAvatar(
                            radius: 50,
                            backgroundColor: Colors.white,
                            backgroundImage: AssetImage(Images.splashLogo),
                              // child: Image.asset(Images.splashLogo, width: 130, height: 100)
                          ),
                        )]))]),
