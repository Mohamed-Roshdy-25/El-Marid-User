              ...
              Padding(padding:  const EdgeInsets.all(Dimensions.paddingSizeDefault),
                  child: Container(padding:  const EdgeInsets.all(Dimensions.paddingSizeSmall),
                      ...
                      child: Column(children: [
                        ...
                        // MenuButtonWidget(image: Images.category, title: getTranslated('sellers', context),
                        //     navigateTo: const AllTopSellerScreen( title: 'top_stores',)),

                        MenuButtonWidget(image: Images.category, title: getTranslated('brands', context),
                            navigateTo: const BrandsView()),
