...
class AppConstants {
  static const String appName = 'Marid';
  ...
  static const String baseUrl = 'https://camp-coding.site/elmared';
...
static const String otpVerificationForDigitalProduct = '/api/v1/customer/order/digital-product-download-otp-verify';
  ...
  static const String getAppColor = '/api/v3/seller/auth/get_colors';
